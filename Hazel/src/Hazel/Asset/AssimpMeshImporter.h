...
namespace Hazel {
	...
	public:
		...
		bool ImportAnimation(const std::string_view animationName, const Skeleton& skeleton, const bool isMaskedRootMotion, const glm::vec3& rootTranslationMask, float rootRotationMask, Scope<Animation>& animation) { return false; }
		bool IsCompatibleSkeleton(const std::string_view animationName, const Skeleton& skeleton) { return false; }
